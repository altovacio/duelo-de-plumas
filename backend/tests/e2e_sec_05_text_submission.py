...
async def test_05_09_admin_submits_text3_2_to_contest1_succeeds(client: AsyncClient): # MODIFIED: async def, AsyncClient
    ...
    if test_data.get("admin_user_id") not in [p.user_id for p in contest1_before_data.participants if hasattr(p, 'user_id')]:
...
async def test_05_10_user1_views_submissions_contest1_succeeds(client: AsyncClient): # MODIFIED: async def, AsyncClient
    ...
    current_text_count = ContestResponse(**contest_resp.json()).text_count
...
async def test_05_14_user1_deletes_own_ai_submission_c1_t1_2_no_refund(client: AsyncClient): # MODIFIED: async def, AsyncClient
    ...
    contest_texts_before = ContestResponse(**contest_before_resp.json()).text_count
    ...
    contest_texts_after = ContestResponse(**contest_after_resp.json()).text_count
...
async def test_05_16_user1_deletes_own_submission_c2_t1_1_succeeds(client: AsyncClient): # MODIFIED: async def, AsyncClient
    ...
    contest2_data_before = ContestResponse(**contest2_before_resp.json())
    ...
    contest2_data_after = ContestResponse(**contest2_after_resp.json())
...
async def test_05_17_user1_deletes_user2_submission_c1_t2_2_succeeds(client: AsyncClient): # MODIFIED: async def, AsyncClient
    ...
    contest1_texts_before = ContestResponse(**contest1_before_resp.json()).text_count
    ...
    contest1_texts_after = ContestResponse(**contest1_after_resp.json()).text_count
