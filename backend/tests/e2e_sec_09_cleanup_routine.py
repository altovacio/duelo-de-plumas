...
def test_09_01_user1_deletes_text1_1(client: TestClient):
    """User 1 deletes Text 1.1."""
    assert "user1_headers" in test_data, "User 1 token not found."
    assert "text1_1_id" in test_data, "Text 1.1 ID not found."

    response = client.delete(
        f"{settings.API_V1_STR}/texts/{test_data['text1_1_id']}",
        headers=test_data["user1_headers"]
    )
    assert response.status_code == 200, f"User 1 deleting Text 1.1 failed: {response.text}"
    print(f"User 1 successfully deleted Text 1.1 (ID: {test_data['text1_1_id']}).")

    del test_data["text1_1_id"]

@pytest.mark.run(after='test_09_01_user1_deletes_text1_1')
def test_09_02_user2_deletes_text2_1(client: TestClient):
    """User 2 deletes Text 2.1."""
    ...
    assert response.status_code == 200, f"User 2 deleting Text 2.1 failed: {response.text}"
    print(f"User 2 successfully deleted Text 2.1 (ID: {test_data['text2_1_id']}).")

    del test_data["text2_1_id"]

@pytest.mark.run(after='test_09_02_user2_deletes_text2_1')
def test_09_03_user1_deletes_text1_2(client: TestClient):
    """User 1 deletes Text 1.2."""
    assert "user1_headers" in test_data, "User 1 token not found."
    assert "text1_2_id" in test_data, "Text 1.2 ID not found."

    response = client.delete(
        f"{settings.API_V1_STR}/texts/{test_data['text1_2_id']}",
        headers=test_data["user1_headers"]
    )
    assert response.status_code == 200, f"User 1 deleting Text 1.2 failed: {response.text}"
    print(f"User 1 successfully deleted Text 1.2 (ID: {test_data['text1_2_id']}).")

    del test_data["text1_2_id"]

@pytest.mark.run(after='test_09_03_user1_deletes_text1_2')
def test_09_04_user2_deletes_text2_2(client: TestClient):
    """User 2 deletes Text 2.2."""
    assert "user2_headers" in test_data, "User 2 token not found."
    assert "text2_2_id" in test_data, "Text 2.2 ID not found."

    response = client.delete(
        f"{settings.API_V1_STR}/texts/{test_data['text2_2_id']}",
        headers=test_data["user2_headers"]
    )
    assert response.status_code == 200, f"User 2 deleting Text 2.2 failed: {response.text}"
    print(f"User 2 successfully deleted Text 2.2 (ID: {test_data['text2_2_id']}).")

    del test_data["text2_2_id"]

@pytest.mark.run(after='test_09_04_user2_deletes_text2_2')
def test_09_05_user1_deletes_text1_3(client: TestClient):
    """User 1 deletes Text 1.3."""
    assert "user1_headers" in test_data, "User 1 token not found."
    assert "text1_3_id" in test_data, "Text 1.3 ID not found."

    response = client.delete(
        f"{settings.API_V1_STR}/texts/{test_data['text1_3_id']}",
        headers=test_data["user1_headers"]
    )
    assert response.status_code == 200, f"User 1 deleting Text 1.3 failed: {response.text}"
    print(f"User 1 successfully deleted Text 1.3 (ID: {test_data['text1_3_id']}).")

    del test_data["text1_3_id"]

@pytest.mark.run(after='test_09_05_user1_deletes_text1_3')
def test_09_06_user2_deletes_text2_3(client: TestClient):
    """User 2 deletes Text 2.3."""
    assert "user2_headers" in test_data, "User 2 token not found."
    assert "text2_3_id" in test_data, "Text 2.3 ID not found."

    response = client.delete(
        f"{settings.API_V1_STR}/texts/{test_data['text2_3_id']}",
        headers=test_data["user2_headers"]
    )
    assert response.status_code == 200, f"User 2 deleting Text 2.3 failed: {response.text}"
    print(f"User 2 successfully deleted Text 2.3 (ID: {test_data['text2_3_id']}).")

    del test_data["text2_3_id"]

@pytest.mark.run(after='test_09_06_user2_deletes_text2_3')
def test_09_07_admin_deletes_text3_1(client: TestClient):
    """Admin deletes Text 3.1."""
    assert "admin_headers" in test_data, "Admin token not found."
    assert "text3_1_id" in test_data, "Text 3.1 ID not found."

    response = client.delete(
        f"{settings.API_V1_STR}/texts/{test_data['text3_1_id']}",
        headers=test_data["admin_headers"]
    )
    assert response.status_code == 200, f"Admin deleting Text 3.1 failed: {response.text}"
    print(f"Admin successfully deleted Text 3.1 (ID: {test_data['text3_1_id']}).")

    del test_data["text3_1_id"]

@pytest.mark.run(after='test_09_07_admin_deletes_text3_1')
def test_09_08_admin_deletes_text3_2(client: TestClient):
    """Admin deletes Text 3.2."""
    assert "admin_headers" in test_data, "Admin token not found."
    assert "text3_2_id" in test_data, "Text 3.2 ID not found."

    response = client.delete(
        f"{settings.API_V1_STR}/texts/{test_data['text3_2_id']}",
        headers=test_data["admin_headers"]
    )
    assert response.status_code == 200, f"Admin deleting Text 3.2 failed: {response.text}"
    print(f"Admin successfully deleted Text 3.2 (ID: {test_data['text3_2_id']}).")

    del test_data["text3_2_id"]

@pytest.mark.run(after='test_09_08_admin_deletes_text3_2')
def test_09_09_admin_deletes_text3_3(client: TestClient):
    """Admin deletes Text 3.3."""
    assert "admin_headers" in test_data, "Admin token not found."
    assert "text3_3_id" in test_data, "Text 3.3 ID not found."

    response = client.delete(
        f"{settings.API_V1_STR}/texts/{test_data['text3_3_id']}",
        headers=test_data["admin_headers"]
    )
    assert response.status_code == 200, f"Admin deleting Text 3.3 failed: {response.text}"
    print(f"Admin successfully deleted Text 3.3 (ID: {test_data['text3_3_id']}).")

    del test_data["text3_3_id"]

@pytest.mark.run(after='test_09_09_admin_deletes_text3_3')
def test_09_10_user1_deletes_writer1(client: TestClient):
    """User 1 deletes writer1."""
    assert "user1_headers" in test_data, "User 1 token not found."
    assert "writer1_id" in test_data, "Writer 1 ID not found."

    response = client.delete(
        f"{settings.API_V1_STR}/agents/{test_data['writer1_id']}",
        headers=test_data["user1_headers"]
    )
    assert response.status_code == 200, f"User 1 deleting writer1 failed: {response.text}"
    print(f"User 1 successfully deleted writer1 (ID: {test_data['writer1_id']}).")

    del test_data["writer1_id"]

@pytest.mark.run(after='test_09_10_user1_deletes_writer1')
def test_09_11_admin_deletes_writer_global(client: TestClient):
    """Admin deletes writer_global."""
    assert "admin_headers" in test_data, "Admin token not found."
    ...
    assert response.status_code == 200, f"Admin deleting writer_global failed: {response.text}"
    print(f"Admin successfully deleted writer_global (ID: {test_data['writer_global_id']}).")

    del test_data["writer_global_id"]

@pytest.mark.run(after='test_09_11_admin_deletes_writer_global')
def test_09_12_user1_deletes_contest1(client: TestClient):
    """User 1 deletes contest1."""
    assert "user1_headers" in test_data, "User 1 token not found."
    ...
    assert response.status_code == 200, f"User 1 deleting contest1 failed: {response.text}"
    print(f"User 1 successfully deleted contest1 (ID: {test_data['contest1_id']}).")

    del test_data["contest1_id"]

@pytest.mark.run(after='test_09_12_user1_deletes_contest1')
def test_09_13_user1_deletes_contest2(client: TestClient):
    """User 1 deletes contest2."""
    assert "user1_headers" in test_data, "User 1 token not found."
    ...
    assert response.status_code == 200, f"User 1 deleting contest2 failed: {response.text}"
    print(f"User 1 successfully deleted contest2 (ID: {test_data['contest2_id']}).")

    del test_data["contest2_id"]

@pytest.mark.run(after='test_09_13_user1_deletes_contest2')
def test_09_14_admin_deletes_user1(client: TestClient):
    """Admin deletes User 1."""
    assert "admin_headers" in test_data, "Admin token not found."
    assert "user1_id" in test_data, "User 1 ID not found."

    response = client.delete(
        f"{settings.API_V1_STR}/admin/users/{test_data['user1_id']}",
        headers=test_data["admin_headers"]
    )
    assert response.status_code == 200, f"Admin deleting User 1 failed: {response.text}"
    print(f"Admin successfully deleted User 1 (ID: {test_data['user1_id']}).")

    del test_data["user1_id"]

@pytest.mark.run(after='test_09_14_admin_deletes_user1')
def test_09_15_admin_deletes_user2(client: TestClient):
    """Admin deletes User 2."""
    assert "admin_headers" in test_data, "Admin token not found."
    assert "user2_id" in test_data, "User 2 ID not found."

    response = client.delete(
        f"{settings.API_V1_STR}/admin/users/{test_data['user2_id']}",
        headers=test_data["admin_headers"]
    )
    assert response.status_code == 200, f"Admin deleting User 2 failed: {response.text}"
    print(f"Admin successfully deleted User 2 (ID: {test_data['user2_id']}).")

    del test_data["user2_id"]

@pytest.mark.run(after='test_09_15_admin_deletes_user2')
def test_09_16_admin_deletes_self(client: TestClient):
    """Admin deletes self."""
    assert "admin_headers" in test_data, "Admin token not found."
    assert "admin_id" in test_data, "Admin ID not found."

    response = client.delete(
        f"{settings.API_V1_STR}/admin/users/{test_data['admin_id']}",
        headers=test_data["admin_headers"]
    )
    assert response.status_code == 200, f"Admin deleting self failed: {response.text}"
    print(f"Admin successfully deleted self (ID: {test_data['admin_id']}).")

    del test_data["admin_id"]
